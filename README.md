...
A local web UI for managing Docker Compose stacks. Define your services once, build reusable templates, and deploy or stop your entire stack with a single click.
